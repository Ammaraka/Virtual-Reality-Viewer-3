...
#                  dst="updater.exe")
    ...
    def package_finish(self):
        ...
        symbolZip.write("%s/Angstrom-bin.exe" % self.args['configuration'].lower(),"Firestorm-bin.exe")
        symbolZip.write("%s/Angstrom-bin.pdb" % self.args['configuration'].lower(),"Firestorm-bin.pdb")
...
class LinuxManifest(ViewerManifest):
    def construct(self):
        ...
        self.path("angstrom-bin","bin/do-not-directly-run-angstrom-bin")
    ...
    def package_finish(self):
        # a standard map of strings for replacing in the templates
        installer_name_components = [self.channel_oneword(),self.args.get('arch'),'.'.join(self.args['version'])]
