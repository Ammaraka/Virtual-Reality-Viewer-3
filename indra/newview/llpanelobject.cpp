...
void LLPanelObject::updateLimits()
{
	...
	mCtrlScaleX->setMinValue(LLWorld::getInstance()->getMinPrimXPos());
	mCtrlScaleX->setMaxValue(LLWorld::getInstance()->getMaxPrimXPos());
	mCtrlScaleY->setMinValue(LLWorld::getInstance()->getMinPrimYPos());
	mCtrlScaleY->setMaxValue(LLWorld::getInstance()->getMaxPrimYPos());
	mCtrlScaleZ->setMinValue(LLWorld::getInstance()->getMinPrimZPos());
	mCtrlScaleZ->setMaxValue(LLWorld::getInstance()->getMaxPrimZPos());
