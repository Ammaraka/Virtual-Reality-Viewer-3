...
Push $2
  ...
  MessageBox MB_OK "This uninstall will NOT delete your Angstrom chat logs and other private files. If you want to do that yourself, delete the Angstrom folder within your user Application data folder"
...
DetailPrint "Removing Angstrom saved passwords"
...
; </FS:Ansariel> Commented out; Warning in build log about not being used
	...
	WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\The Angstrom Viewer Project\${INSTNAME}" "InstallerLanguage" $LANGUAGE
lbl_return:
    Pop $0
    Return
FunctionEnd
...
WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\The Angstrom Project\$INSTPROG" "Exe" "$INSTEXE"
